...
INSERT Assessment (typ, benutzername, abgeschlossen) VALUES ('VORTRAINING', 'maxmuster', True);
...
INSERT Assessment (assessmentID, typ, benutzername, abgeschlossen) VALUES (LAST_INSERT_ID(), 'NACHTRAINING', 'maxmuster', True);
INSERT benutzer_beantwortet_szenario (szenarioID, assessmentID, typ, benutzername, korrekt)
VALUES (
    (SELECT MAX(b.szenarioID) FROM (SELECT a.szenarioID FROM Szenario a WHERE kapitelnummer=3 ORDER BY szenarioID ASC LIMIT 9) b ),
    LAST_INSERT_ID(),
    'NACHTRAINING',
    'maxmuster', 
    False
), (
    (SELECT MAX(b.szenarioID) FROM (SELECT a.szenarioID FROM Szenario a WHERE kapitelnummer=3 ORDER BY szenarioID ASC LIMIT 10) b ),
    LAST_INSERT_ID(),
    'NACHTRAINING',
    'maxmuster', 
    True
), (
    (SELECT MAX(b.szenarioID) FROM (SELECT a.szenarioID FROM Szenario a WHERE kapitelnummer=3 ORDER BY szenarioID ASC LIMIT 11) b ),
    LAST_INSERT_ID(),
    'NACHTRAINING',
    'maxmuster', 
    True
    ...
    (SELECT MAX(b.szenarioID) FROM (SELECT a.szenarioID FROM Szenario a WHERE kapitelnummer=3 ORDER BY szenarioID ASC LIMIT 12) b ),
    LAST_INSERT_ID(),
    'NACHTRAINING',
    'maxmuster', 
    True
    ...
    (SELECT MAX(b.szenarioID) FROM (SELECT a.szenarioID FROM Szenario a WHERE kapitelnummer=3 ORDER BY szenarioID ASC LIMIT 13) b ),
    LAST_INSERT_ID(),
    'NACHTRAINING',
    'maxmuster', 
    True
    ...
    (SELECT MAX(b.szenarioID) FROM (SELECT a.szenarioID FROM Szenario a WHERE kapitelnummer=3 ORDER BY szenarioID ASC LIMIT 14) b ),
    LAST_INSERT_ID(),
    'NACHTRAINING',
    'maxmuster', 
    False
), (
    (SELECT MAX(b.szenarioID) FROM (SELECT a.szenarioID FROM Szenario a WHERE kapitelnummer=3 ORDER BY szenarioID ASC LIMIT 15) b ),
    LAST_INSERT_ID(),
    'NACHTRAINING',
    'maxmuster', 
    False
), (
    (SELECT MAX(b.szenarioID) FROM (SELECT a.szenarioID FROM Szenario a WHERE kapitelnummer=3 ORDER BY szenarioID ASC LIMIT 16) b ),
    LAST_INSERT_ID(),
    'NACHTRAINING',
    'maxmuster', 
    True
...
INSERT Assessment (typ, benutzername, abgeschlossen) VALUES ('PRUEFUNG', 'maxmuster', False);
INSERT Assessment (typ, benutzername, abgeschlossen) VALUES ('PRUEFUNG', 'maxmuster', True);
INSERT benutzer_beantwortet_szenario (szenarioID, assessmentID, typ, benutzername, korrekt)
VALUES (
